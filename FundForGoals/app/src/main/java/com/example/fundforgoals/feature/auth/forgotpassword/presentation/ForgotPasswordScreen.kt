...
@Composable
private fun ForgotPasswordCompactScreen(
    uiState: ForgotPasswordUiState,
    onAction: (ForgotPasswordAction) -> Unit,
    modifier: Modifier = Modifier
) {
...
@Composable
private fun ForgotPasswordExpandedScreen(
    uiState: ForgotPasswordUiState,
    onAction: (ForgotPasswordAction) -> Unit,
    modifier: Modifier = Modifier
) {
...
private fun ForgotPasswordContent(
    ...
    Box(
        ...
        Column(
            ...
            BackButton(
                onClick = { onAction(ForgotPasswordAction.OnBackClick) }
            )
            ...
            OutlinedTextField(
                ...
                onValueChange = { onAction(ForgotPasswordAction.OnUsernameChange(it)) },
                placeholder = {
                    Text(
                        text = "Username",
            ...
            PasswordField(
                ...
                onValueChange = {
                    onAction(ForgotPasswordAction.OnNewPasswordChange(it))
                },
                placeholder = "Password",
                visible = uiState.showNewPassword,
                onToggleVisibility = {
                    onAction(ForgotPasswordAction.OnToggleNewPasswordVisibility)
                },
            ...
            PasswordField(
                ...
                onValueChange = {
                    onAction(ForgotPasswordAction.OnConfirmPasswordChange(it))
                },
                placeholder = "Password",
        ...
        if (uiState.showSuccessDialog) {
            AlertDialog(
                onDismissRequest = {
                    onAction(ForgotPasswordAction.OnDismissDialog)
                },
                confirmButton = {
                    Button(
                        onClick = {
                            onAction(ForgotPasswordAction.OnDialogOkClick)
                        },
                        colors = ButtonDefaults.buttonColors(
                            containerColor = MaterialTheme.colorScheme.primary,
                            contentColor = MaterialTheme.colorScheme.onPrimary
                ...
                text = {
                    Text(
                        text = "The password for ${uiState.username} has been updated successfully.",
                        fontSize = 16.sp,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                },
